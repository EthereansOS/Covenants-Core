...
contract FarmingGen2Extension is IFarmingGen2Extension {
    ...
    function init(bool byMint, address host, address treasury) public virtual override {
        ...
        _rewardTokenAddress = IFarmingGen2(_farmMainContract = msg.sender)._rewardTokenAddress();
        _byMint = byMint;
    ...
    function setFarmingSetups(FarmingSetupConfiguration[] memory farmingSetups) public virtual override hostOnly {
        IFarmingGen2(_farmMainContract).setFarmingSetups(farmingSetups);
    }
