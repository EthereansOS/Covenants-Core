...
describe("FarmingGen1", () => {
    ...
    before(async () => {
        try {
            ...
            FarmMainGen1 = await compile('farming/FarmMainGen1');
            ...
            FarmExtensionGen1 = await compile('farming/FarmExtensionGen1');
    ...
    it("should deploy farm factory, extensions and finalize proposals", async () => {
        try {
            ...
            var farmMainModel = await new web3.eth.Contract(FarmMainGen1.abi).deploy({data : FarmMainGen1.bin}).send(blockchainConnection.getSendingOptions());
            ...
            var farmExtensionModel = await new web3.eth.Contract(FarmExtensionGen1.abi).deploy({data : FarmExtensionGen1.bin}).send(blockchainConnection.getSendingOptions());
            ...
            farmMainExtension = new web3.eth.Contract(FarmExtensionGen1.abi, farmMainExtensionAddress);
            ...
            clonedFarmExtension = new web3.eth.Contract(FarmExtensionGen1.abi, clonedDefaultFarmExtension);
        } catch (error) {
    ...
    it("should deploy simple farm main contract", async () => {
        try {
            ...
            var params = [
                ...
                abi.encode(["tuple(bool,uint256,uint256,uint256,uint256,uint256,uint256,address,address,address,address,bool,uint256,uint256,uint256)[]"], [setups]),
            ];
            ...
            farmMainContract = await new web3.eth.Contract(FarmMainGen1.abi, farmMainContractAddress);
